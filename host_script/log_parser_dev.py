...
for log_idx in range(1,6):
    ...
    # Create the transitions files
    with open(f"{analysis_path}/transitions_192.168.1.21" + str(log_idx) + ".txt", "w") as f:
